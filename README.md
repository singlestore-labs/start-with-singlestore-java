Getting started with MemSQL and Java
====================================

Whether you're using an ORM or straight SQL, you can get started with MemSQL fast. Here's an introductory sample of using MemSQL with Java. This sample includes all the CRUD methods: Create, Read by id, Read all, Update, and Delete.
